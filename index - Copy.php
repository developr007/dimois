                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6">
                        <div class="topbar__three-left lg-t-center">
                            <a href="#"><i class="fas fa-bell icon-animation"></i>Building the next best shopping experience in Saudi.</a>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="topbar__three-right t-right lg-t-center">
                            <ul>
                                ...
                                <li><a href="mmr-stores.php"><i class="fas fa-shopping-cart"></i>Explore MMR Stores.</a></li>
                ...
                <div class="header__area-menubar three">
                    <div class="header__area-menubar-left">
                        <div class="header__area-menubar-left-logo">
                            ...
                            <!-- <a href="index.php"><img class="dark-n" src="assets/img/logo-6.png" alt=""><img class="light-n" src="assets/img/logo-7.png" alt=""></a> -->
                        </div>
                    </div>
                    <div class="header__area-menubar-center">
                        <div class="header__area-menubar-center-menu three menu-responsive">
                            <ul id="mobilemenu">
                                ...
                                <li class="menu-item-has-children"><a href="mmr-stores.php">MMR Stores</a>
                        ...
                        <div class="banner__three-title-bottom">
                            ...
                            <div class="banner__three-title-bottom-video">
                                <div class="banner__three-title-bottom-video-icon">
                                    <a class="video-popup" href="https://www.youtube.com/watch?v=VjAGd_CdMIs"><i
                    ...
                    <div class="swiper banner__three__slider banner__three-image dark__imagej">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <a class="video-popup" href="https://www.youtube.com/watch?v=VjAGd_CdMIs">
                ...
                <div class="col-xl-12">
                    <div class="features-area">
                        <div class="features-area-item ltb-radius">
                            ...
                            <p>DGC is a global startup that is building macro business models to make it easy to start and grow businesses in different industries.</p>
                        </div>
                        ...
                        <div class="features-area-item rtb-radius" >
                            ...
                            <h4>Mission</h4>
                            <p>
                                Build the best grocery shopping experience (brand)  that is, high in cost savings, best in freshness and time-saving.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-lg-6 lg-mb-30">
                    <div class="about__three-title" id="about_usj">
                        ...
                        <div class="about__three-title-faq-text">
                            ...
                            <a class="btn-eight" href="mmr-stores.php">Learn More<i
                                    class="far fa-chevron-double-right"></i></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 md-mb-30">
                    <div class="footer__three-widget">
                        <div class="footer__three-widget-about">
                            <!-- <a href="index.php"><img class="dark-n" src="assets/img/logo-6.png" alt=""><img class="light-n" src="assets/img/logo-7.png" alt=""></a> -->
                            <a href="#index.php"><img class="dark-n" src="assets/img/Dimois_light.svg" alt=""><img
                                    class="light-n" src="assets/img/Dimois_dark.svg" alt=""></a>
                            <p>DGC is a global startup that makes it easy for people who want to start small business in
                                the GCC.
                                As Of Now,DGC Has Launched MMR Stores In Saudi Arabia,A Store Partner For Grocery
                                Stores/Supermarkets.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="footer__three-widget border-one tow">
                        ...
                        <div class="footer__three-widget-hour">
                            ...
                            <div class="footer__three-widget-hour-social">
                                <ul>
                                    <li><a
                                            href="https://www.facebook.com/profile.php?id=100089367236804&mibextid=LQQJ4d"><i
