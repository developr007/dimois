...
<!-- Mirrored from html.themeori.com/conbix/project-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Jan 2023 08:51:57 GMT -->
                    ...
                    <div class="header__area-menubar-center">
                        <div class="header__area-menubar-center-menu three menu-responsive">
                            <ul id="mobilemenu">
                                ...
                                <li class="menu-item-has-children"><a href="index.php#about_us">About Us</a>
                                </li>
                                <!-- <li class="menu-item-has-children"><a href="index.php#send_mail">Send mail</a> -->

                                </li>
                             
                                <li class="menu-item-has-children"><a href="#">MMR Stores</a>
                                <li class="menu-item-has-children"><a href="index.php#contact">Contact us</a>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="project__details-area">
                        ...
                        <a class="btn-eight" href="index.php#send_mail">Get in Touch Now
